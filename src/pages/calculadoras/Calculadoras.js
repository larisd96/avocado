				...
				<div className='calculator-about-basal'>
					...
					<p className='calculator-basal-paragraph1'>
						...
						<p className='calculator-basal-paragraph1'>
							...
							estão as equações básicas para calcular a TMB de acordo com o sexo: Para homens:
						</p>
						<p className='calculator-basal-paragraph1'>TMB = 88,362 + (13,397 x peso em kg) + (4,799 x altura em cm) - (5,677 x idade em anos)</p>
						<p className='calculator-basal-paragraph1'>
							Para mulheres: TMB = 447,593 + (9,247 x peso em kg) + (3,098 x altura em cm) - (4,330 x idade em anos) Após calcular a TMB, você pode ajustar essa quantidade de calorias com base na
							atividade física diária da pessoa usando um fator de atividade. O resultado final ajudará a determinar a quantidade de calorias necessárias para manter o peso atual, perder peso ou
							ganhar peso, dependendo dos objetivos individuais de saúde e condicionamento físico. Lembrando que a TMB é apenas um ponto de partida, e outros fatores, como genética, metabolismo
