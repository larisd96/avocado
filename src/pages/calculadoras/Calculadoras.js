...
const Calculadoras = () => {
	return (
		<div className='calculator-imc'>
			<h1 className='calculator-title-imc'>Calcule seu IMC</h1>
			<p className='calculator-about-imc'>
			...
			<div className='calculator-basal'>
				...
				<p className='calculator-about-basal'>
					...
					essa quantidade de calorias com base na atividade física diária da pessoa usando um fator de atividade. O resultado final ajudará a determinar a quantidade de calorias necessárias para
					manter o peso atual, perder peso ou ganhar peso, dependendo dos objetivos individuais de saúde e condicionamento físico. Lembrando que a TMB é apenas um ponto de partida, e outros fatores,
